...
icon: <Smile className="w-6 h-6 text-emerald-800" />,
  ...
  //   description:
  //     "IBIS Noida is popular due to comfort and practicality, and Spa In Gurgaon is the one that makes your relaxation instantly available to your door. You can experience stress relief, sore muscles, and complete recharge with our massages customized to your needs while on-site. Each session has been designed to be comfortable.",
  // }, 
  // {
  //   title: "Jaypee Vasant Noida",
  //   image: "/images/jaypeeVasantNoida.png",
  //   description:
  //     "At Jaypee Vasant Noida, Spa In Gurgaon creates a soothing break from the demands of travel. Our spa in Mahipalpur relaxes the body, reduces stress, and gives clarity to the mind. Getting a professional service in the comfort of your hotel room means enjoying a relaxing getaway without having to leave the comfort of your room. ",
  // },
  // {
...
{/* End Our Process */}
  const services = [
    ...
    {
      title: "Thai Massage",
      description: "Thai Massage incorporates body stretches with pressure therapy to open extracted muscles, relieve pain, and enhance the flexibility without affecting the relaxation.",
      icon: "🪨",
    },
    {
      title: "Aromatherapy Massage",
      description: "Aromatherapy Massage focuses on aromatic oils and gentle strokes to soothe your nerves, rejuvenate your skin, and provide you with a psychological balanced fragrance.",
      icon: "🪨",
    },
  ];
  const services1 = [
  ...
  },
  {
    id: 'couple',
    title: 'Couple Massage',
    desc: 'Shared, synchronised therapy for two — perfect for couples staying at Noida hotels.',
    duration: '60 / 90 mins',
    price: '₹3,499 - ₹4,999',
    icon: (
      <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
...
<div className=" text-gray-800">
    {/* banner */}
          <section className="relative w-full h-[70vh] flex items-center justify-center">
                {/* Background Image */}
                <Image
                  src="/images/NoidaImage.jpg" // apni spa banner image ka path
                  alt="Luxury Body Spa"
                  fill
                  priority
                ...
                >
                  <h1 className="text-4xl md:text-6xl font-bold text-white drop-shadow-lg">
                    About <span className="text-emerald-300">Our Outles In Noida</span>
                  </h1>
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 py-16 md:py-24 lg:grid-cols-2">
        ...
        <div className="text-center lg:text-left">
          ...
          <h1 className="space-y-2 text-4xl font-light leading-tight text-gray-900 md:text-5xl">
            ...
            <span className="block font-medium">Noida to Enjoy <span className="text-rose-600">Relaxation</span></span>
          </h1>

          <p className="mx-auto mt-4 max-w-xl leading-relaxed text-gray-600 lg:mx-0">
            Enter a peaceful space of calm and comfort with Spa in Gurgaon’s exclusive massage therapies in Noida. Our professional therapists also provide some relaxing treatments that relax your body, restore your balance, and refresh your mind. B2B therapy, a complete-body session, or any other type of service, all of it is designed to make you feel relaxed fully. Every massage makes you feel lighter, refreshed and prepared to get to the next day.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div 
                  ...
                  >
                    ...
                    >
                      Our Luxury Outlets <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-emerald-800">For Hotel Spa in Noida</span>
                    </motion.h2>
                    ...
                    >
                    Spa in Gurgaon provides the high quality of spa in Noida hotels. Skilled therapists bring luxury and ease directly to your hotel room so you can enjoy deep relaxation without leaving your space.
                    </motion.p>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-14 text-center">
          ...
          >
            Our Hotel <span className="bg-gradient-to-r from-emerald-600 to-emerald-400 bg-clip-text text-transparent">Massage in Noida</span>
          </motion.h2>
          ...
          >
          We are a hotel with massage services that are meant to bring relaxation and luxury to wherever you are in Noida. Every session is devoted to the overall comfort and peace of mind.
          </motion.p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { k: 'inroom', label: 'In‑Room Service', sub: 'At leading Noida hotels' },
      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-3xl text-gray-600">
            Ease into serenity at our Gurgaon Noida outlet. Thoughtfully curated rituals, discreet in-room options, and
          ...
          >
            <div className="relative overflow-hidden rounded-2xl border border-[#e8d5c9] bg-white/70 shadow-2xl">
              <div className="relative h-[440px] w-full">
                <Image src="/images/best-western-merrion.jpg" alt="Serene spa ambience at Gurgaon Noida outlet" fill className="object-cover" />
              </div>
              {/* Overlay content */}
              ...
              <div className="absolute inset-x-0 bottom-0 flex items-center justify-between gap-4 p-4">
                <div>
                  <div className="font-serif text-lg font-semibold text-white">Gurgaon · Noida</div>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-3xl text-[#4b3f3b]/80">
            Browse a few guest‑favorite experiences at our Noida outlet. Designed to help you reset fast—before or after your flight.
          </p>
        </motion.header>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              <div className="relative col-span-2 h-64 overflow-hidden rounded-2xl border border-[#e8d5c9]">
                <Image src="/images/fpkdl.com_960_1760686305_beautiful-young-woman-reciving-relxing-massage-massage-concept-body-massage-massage-health_299057-864.jpg" alt="Serene spa ambience at Noida" fill className="object-cover" />
              </div>
          ...
          <motion.div
            ...
            className="relative rounded-2xl border border-[#e8d5c9] bg-white/80 p-8 shadow-lg backdrop-blur-sm"
          >
            <h3 className="font-serif text-2xl font-semibold text-emerald-800">Why Guests Love Our Noida Outlet</h3>
    ...
    {/* content section */}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#3a2e2a] mt-4 mb-4 font-serif">Why Choose Spa in Gurgaon as Best Centre for Massage in Noida</h1>
          <div className="mx-auto w-28 h-1 bg-emerald-600 rounded-full" />
          <p className="mt-4 text-gray-600 max-w-3xl mx-auto">
           Relaxation meets real expertise at Spa in Gurgaon. Here is why spa lovers in Noida keep choosing us.
          </p>
        </motion.div>
        ...
        <header className="text-center mb-14">
          ...
          >
            <span className="block font-[Great_Vibes] text-4xl md:text-5xl text-emerald-800">
              How to Book Luxury Massage in Noida&apos;s
            </span>
      ...
      <div className="container mx-auto px-6 md:px-10 xl:px-20">
        ...
        >
          <h2 className="text-center text-3xl md:text-5xl font-serif font-extrabold text-emerald-900 leading-tight mb-6">
            Benefits of Booking Hotel Massage in Noida at Best Hotels
          </h2>
          ...
          <p className="text-xs text-gray-500 text-center mt-8">Available at selected premium hotels in Noida. Terms &amp; conditions apply.</p>
        </motion.div>
      </div>
    </section>
...
{/* Pricing Section */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              ...
              <div className="text-center mb-16">
                ...
                <motion.h2
                  ...
                  transition={{ delay: 0.1 }}
                >
                  Our Pricing <span className="text-emerald-600">Package for Hotel Spa in Noida</span>
                </motion.h2>
                <motion.p
      ...
      {/* <div className="bg-white py-14 px-6 md:px-20">
        <div className="max-w-5xl mx-auto space-y-6 text-gray-700 text-lg leading-relaxed">
          <h2 className="text-2xl font-bold text-emerald-700 mb-4 text-center">Why Choose Our Spa in Noida?</h2>
          <p>
...
<motion.div
      ...
      >
        ...
        <p className="text-emerald-800 max-w-2xl text-lg">
          Here is what guests usually ask before they book their massage in Noida.
        </p>
